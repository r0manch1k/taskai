...
В качестве брокера сообщений для создания задач с использованием ИИ Агента используется RabbitMQ. Для настройки используются переменные окружения
...
Для работы ИИ-Агента необходимо ввести свой ключ OpenRouter в переменную окружения

```sh
OPENROUTER_API_KEY='key'
```

Для запуска брокера введите команду
